...
cbuffer MATERIAL : register(b1) //만들어 둔 상수 버퍼의 타입 별 변수
{
    int g_int_0;
    int g_int_1;
    int g_int_2;
...
Texture2D g_tex_0 : register(t0);//실제 텍스쳐의 주소
...
SamplerState g_sam_0 : register(s0); // device에서 생성 후 update함
