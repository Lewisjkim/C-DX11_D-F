...
private:
    ...
    UI* m_ChangeNode;
    UI_DELEGATE_1   m_ChangeNameFunc;

    UI* m_CreatePrefabNode;
    UI_DELEGATE_1   m_CreatePrefabFunc;
...
public:
    ...
    void AddDynamic_CreatePrefab(UI* _UI, UI_DELEGATE_1 _MemFunc)
    {
        m_CreatePrefabNode = _UI;
        m_CreatePrefabFunc = _MemFunc;
    }

    void AddDynamic_ChangeName(UI* _UI, UI_DELEGATE_1 _MemFunc)
    {
        m_ChangeNode = _UI;
        m_ChangeNameFunc = _MemFunc;
    }
...
private:
    ...
    void CreatePrefab(TreeNode* _Node);
    void ChangeNameNode(TreeNode* _Node);
