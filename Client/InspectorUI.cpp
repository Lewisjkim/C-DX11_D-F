	...
	, m_arrResUI{}
{
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::CAMERA]->SetSize(0.f, 450.f);
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::ANIMATOR2D]->SetSize(0.f, 500.f);
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::ANIMATOR2D]);

	m_arrComUI[(UINT)COMPONENT_TYPE::LIGHT2D] = new Light2DUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::LIGHT2D]->SetSize(0.f, 200.f);
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::LIGHT2D]);

	m_arrComUI[(UINT)COMPONENT_TYPE::TILEMAP] = new TileMapUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::TILEMAP]->SetSize(0.f, 350.f);
	...
	/*m_arrComUI[(UINT)COMPONENT_TYPE::PREFAB] = new PrefabUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::PREFAB]->SetSize(0.f, 150.f);
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::PREFAB]);*/
...
{
	SetTargetObject(nullptr);//처음시작할 때 선택된 오브젝트 없음
}
